...
AddEventHandler('syn_search:TakeFromsteal', function(obj)
    local _source = source
    TriggerClientEvent('lawmen:GetSearchItems', _source, obj)
    TriggerClientEvent('lawmen:GetSearchWeapons', _source, obj)
    TriggerClientEvent("vorp_inventory:CloseInv", _source)
end)

RegisterServerEvent('lawmen:SearchPlayersItems')
...
RegisterServerEvent('lawmen:ReloadItemInventory')
AddEventHandler('lawmen:ReloadItemInventory', function(steal_source, player_source)
    local _steal_source = steal_source
    local _source
...
RegisterServerEvent('lawmen:ReloadWeaponInventory')
AddEventHandler('lawmen:ReloadWeaponInventory', function(steal_source, player_source)
    local _steal_source = steal_source
    local _source
    if not player_source then
        _source = source
